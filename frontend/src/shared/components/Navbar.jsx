          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            {isAuthenticated() && (
              <>
                ...
                {/* RideFlex — highlighted amber pill */}
                <Link
                  to="/rides/request"
                  className="flex items-center gap-1.5 px-4 py-2 bg-amber-500 hover:bg-amber-400 text-white font-semibold rounded-lg transition-all duration-200 shadow-md shadow-amber-500/25 text-sm"
                >
